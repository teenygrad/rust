...
pub use triton::*;
        ...
        pub extern "C" fn tensor_add < T : Triton, D : types :: Dtype, const
BLOCK_SIZE : u32 >
(x_ptr : T :: Pointer < D > , y_ptr : T :: Pointer < D > , output_ptr : T ::
Pointer < D > , n_elements : T :: I32,)
{
    let pid = T :: program_id(ProgramAxis :: Axis0); let block_start = pid *
    BLOCK_SIZE; let offsets = T :: arange(0, BLOCK_SIZE) + block_start; let
    mask = offsets.lt(n_elements); let x = T ::
