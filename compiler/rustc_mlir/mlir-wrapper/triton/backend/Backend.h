...
enum MlirPass {
  ...
  ttgpuir_stage_shared_memory,
  ttgpuir_lower_indexed_shared_memory,
...
private:
  ...
  std::unordered_map<MlirPass, std::unique_ptr<Pass> (*)()> m_pass_fns = {
      ...
      {MlirPass::ttgpuir_stage_shared_memory,
       createTritonGPUStageSharedMemory},
      {MlirPass::ttgpuir_lower_indexed_shared_memory,
       createTritonGPULowerIndexedSharedMemory},
